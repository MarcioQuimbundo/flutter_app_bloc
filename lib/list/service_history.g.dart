...
ServiceHistory _$ServiceHistoryFromJson(Map<String, dynamic> json) {
  return ServiceHistory(
    ...
    ..serviceDate =
        json['serviceDate'] == null ? null : DateTime.parse(json['serviceDate'] as String)
    ..serviceTime =
        json['serviceTime'] == null ? null : DateTime.parse(json['serviceTime'] as String);
}

Map<String, dynamic> _$ServiceHistoryToJson(ServiceHistory instance) => <String, dynamic>{
      'id': instance.id,
